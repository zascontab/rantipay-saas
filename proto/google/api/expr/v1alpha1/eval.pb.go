...
const file_google_api_expr_v1alpha1_eval_proto_rawDesc = "" +
	"\n" +
	"#google/api/expr/v1alpha1/eval.proto\x12\x18google.api.expr.v1alpha1\x1a$google/api/expr/v1alpha1/value.proto\x1a\x1egoogle/rpc/status/status.proto\"\xc2\x01\n" +
	"\tEvalState\x12;\n" +
