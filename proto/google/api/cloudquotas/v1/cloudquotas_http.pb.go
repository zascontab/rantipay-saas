...
const OperationCloudQuotasCreateQuotaPreference = "/google.api.cloudquotas.v1.CloudQuotas/CreateQuotaPreference"
const OperationCloudQuotasGetQuotaInfo = "/google.api.cloudquotas.v1.CloudQuotas/GetQuotaInfo"
const OperationCloudQuotasGetQuotaPreference = "/google.api.cloudquotas.v1.CloudQuotas/GetQuotaPreference"
const OperationCloudQuotasListQuotaInfos = "/google.api.cloudquotas.v1.CloudQuotas/ListQuotaInfos"
const OperationCloudQuotasListQuotaPreferences = "/google.api.cloudquotas.v1.CloudQuotas/ListQuotaPreferences"
const OperationCloudQuotasUpdateQuotaPreference = "/google.api.cloudquotas.v1.CloudQuotas/UpdateQuotaPreference"
...
func RegisterCloudQuotasHTTPServer(s *http.Server, srv CloudQuotasHTTPServer) {
	r := s.Route("/")
	r.GET("/v1/{parent:organizations/.*/locations/.*/services/.*}/quotaInfos", _CloudQuotas_ListQuotaInfos0_HTTP_Handler(srv))
	r.GET("/v1/{parent:folders/.*/locations/.*/services/.*}/quotaInfos", _CloudQuotas_ListQuotaInfos1_HTTP_Handler(srv))
	r.GET("/v1/{parent:projects/.*/locations/.*/services/.*}/quotaInfos", _CloudQuotas_ListQuotaInfos2_HTTP_Handler(srv))
	r.GET("/v1/{name:organizations/.*/locations/.*/services/.*/quotaInfos/.*}", _CloudQuotas_GetQuotaInfo0_HTTP_Handler(srv))
	r.GET("/v1/{name:folders/.*/locations/.*/services/.*/quotaInfos/.*}", _CloudQuotas_GetQuotaInfo1_HTTP_Handler(srv))
	r.GET("/v1/{name:projects/.*/locations/.*/services/.*/quotaInfos/.*}", _CloudQuotas_GetQuotaInfo2_HTTP_Handler(srv))
	r.GET("/v1/{parent:folders/.*/locations/.*}/quotaPreferences", _CloudQuotas_ListQuotaPreferences0_HTTP_Handler(srv))
	r.GET("/v1/{parent:organizations/.*/locations/.*}/quotaPreferences", _CloudQuotas_ListQuotaPreferences1_HTTP_Handler(srv))
	r.GET("/v1/{parent:projects/.*/locations/.*}/quotaPreferences", _CloudQuotas_ListQuotaPreferences2_HTTP_Handler(srv))
	r.GET("/v1/{name:organizations/.*/locations/.*/quotaPreferences/.*}", _CloudQuotas_GetQuotaPreference0_HTTP_Handler(srv))
	r.GET("/v1/{name:folders/.*/locations/.*/quotaPreferences/.*}", _CloudQuotas_GetQuotaPreference1_HTTP_Handler(srv))
	r.GET("/v1/{name:projects/.*/locations/.*/quotaPreferences/.*}", _CloudQuotas_GetQuotaPreference2_HTTP_Handler(srv))
	r.POST("/v1/{parent:folders/.*/locations/.*}/quotaPreferences", _CloudQuotas_CreateQuotaPreference0_HTTP_Handler(srv))
	r.POST("/v1/{parent:organizations/.*/locations/.*}/quotaPreferences", _CloudQuotas_CreateQuotaPreference1_HTTP_Handler(srv))
	r.POST("/v1/{parent:projects/.*/locations/.*}/quotaPreferences", _CloudQuotas_CreateQuotaPreference2_HTTP_Handler(srv))
	r.PATCH("/v1/{quota_preference.name:folders/.*/locations/.*/quotaPreferences/.*}", _CloudQuotas_UpdateQuotaPreference0_HTTP_Handler(srv))
	r.PATCH("/v1/{quota_preference.name:organizations/.*/locations/.*/quotaPreferences/.*}", _CloudQuotas_UpdateQuotaPreference1_HTTP_Handler(srv))
	r.PATCH("/v1/{quota_preference.name:projects/.*/locations/.*/quotaPreferences/.*}", _CloudQuotas_UpdateQuotaPreference2_HTTP_Handler(srv))
}
...
func (c *CloudQuotasHTTPClientImpl) CreateQuotaPreference(ctx context.Context, in *CreateQuotaPreferenceRequest, opts ...http.CallOption) (*QuotaPreference, error) {
	...
	pattern := "/v1/{parent:projects/.*/locations/.*}/quotaPreferences"
...
func (c *CloudQuotasHTTPClientImpl) GetQuotaInfo(ctx context.Context, in *GetQuotaInfoRequest, opts ...http.CallOption) (*QuotaInfo, error) {
	var out QuotaInfo
	pattern := "/v1/{name:projects/.*/locations/.*/services/.*/quotaInfos/.*}"
...
func (c *CloudQuotasHTTPClientImpl) GetQuotaPreference(ctx context.Context, in *GetQuotaPreferenceRequest, opts ...http.CallOption) (*QuotaPreference, error) {
	var out QuotaPreference
	pattern := "/v1/{name:projects/.*/locations/.*/quotaPreferences/.*}"
	path := binding.EncodeURL(pattern, in, true)
...
func (c *CloudQuotasHTTPClientImpl) ListQuotaInfos(ctx context.Context, in *ListQuotaInfosRequest, opts ...http.CallOption) (*ListQuotaInfosResponse, error) {
	...
	pattern := "/v1/{parent:projects/.*/locations/.*/services/.*}/quotaInfos"
	path := binding.EncodeURL(pattern, in, true)
...
func (c *CloudQuotasHTTPClientImpl) UpdateQuotaPreference(ctx context.Context, in *UpdateQuotaPreferenceRequest, opts ...http.CallOption) (*QuotaPreference, error) {
	var out QuotaPreference
	pattern := "/v1/{quota_preference.name:projects/.*/locations/.*/quotaPreferences/.*}"
	path := binding.EncodeURL(pattern, in, false)
