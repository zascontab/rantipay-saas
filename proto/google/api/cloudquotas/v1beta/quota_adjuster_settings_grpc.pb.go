...
func (c *quotaAdjusterSettingsManagerClient) UpdateQuotaAdjusterSettings(ctx context.Context, in *UpdateQuotaAdjusterSettingsRequest, opts ...grpc.CallOption) (*QuotaAdjusterSettings, error) {
	...
	err := c.cc.Invoke(ctx, QuotaAdjusterSettingsManager_UpdateQuotaAdjusterSettings_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *quotaAdjusterSettingsManagerClient) GetQuotaAdjusterSettings(ctx context.Context, in *GetQuotaAdjusterSettingsRequest, opts ...grpc.CallOption) (*QuotaAdjusterSettings, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(QuotaAdjusterSettings)
	err := c.cc.Invoke(ctx, QuotaAdjusterSettingsManager_GetQuotaAdjusterSettings_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedQuotaAdjusterSettingsManagerServer should be embedded to have
...
func (UnimplementedQuotaAdjusterSettingsManagerServer) testEmbeddedByValue() {}
...
func RegisterQuotaAdjusterSettingsManagerServer(s grpc.ServiceRegistrar, srv QuotaAdjusterSettingsManagerServer) {
	// If the following call pancis, it indicates UnimplementedQuotaAdjusterSettingsManagerServer was
