...
const file_google_api_cloudquotas_v1beta_quota_adjuster_settings_proto_rawDesc = "" +
	...
	"updateMask\x12(\n" +
	"\rvalidate_only\x18\x03 \x01(\bB\x03\xe0A\x01R\fvalidateOnly\"\xdf\x03\n" +
	"\x15QuotaAdjusterSettings\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\bR\x04name\x12d\n" +
	"\n" +
	"enablement\x18\x02 \x01(\x0e2?.google.api.cloudquotas.v1beta.QuotaAdjusterSettings.EnablementB\x03\xe0A\x02R\n" +
	"enablement\x12@\n" +
	"\vupdate_time\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"updateTime\x12\x17\n" +
	"\x04etag\x18\x06 \x01(\tB\x03\xe0A\x01R\x04etag\"C\n" +
	"\n" +
	"Enablement\x12\x1a\n" +
	"\x16ENABLEMENT_UNSPECIFIED\x10\x00\x12\v\n" +
	"\aENABLED\x10\x02\x12\f\n" +
	"\bDISABLED\x10\x03:\xa6\x01\xeaA\xa2\x01\n" +
	...
	"\x1bUpdateQuotaAdjusterSettings\x12A.google.api.cloudquotas.v1beta.UpdateQuotaAdjusterSettingsRequest\x1a4.google.api.cloudquotas.v1beta.QuotaAdjusterSettings\"\x9a\x01\xdaA#quota_adjuster_settings,update_mask\x82\xd3\xe4\x93\x02n:\x17quota_adjuster_settings2S/v1beta/{quota_adjuster_settings.name=projects/*/locations/*/quotaAdjusterSettings}\x12\xdc\x01\n" +
