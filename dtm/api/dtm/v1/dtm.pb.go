...
const file_dtm_api_dtm_v1_dtm_proto_rawDesc = "" +
	"\n" +
	"\x18dtm/api/dtm/v1/dtm.proto\x12\x0edtm.api.dtm.v1\x1a\x13errors/errors.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a(google/api/annotations/annotations.proto\"0\n" +
