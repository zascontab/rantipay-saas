...
const file_user_api_auth_v1_auth_proto_rawDesc = "" +
	"\n" +
	"\x1buser/api/auth/v1/auth.proto\x12\x10user.api.auth.v1\x1a(google/api/annotations/annotations.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x17validate/validate.proto\"\xae\x01\n" +
	"\x13RegisterAuthRequest\x12&\n" +
	"\busername\x18\x01 \x01(\tB\n" +
	"\xe0A\x02\xfaB\x04r\x02\x10\x01R\busername\x12&\n" +
	"\bpassword\x18\x05 \x01(\tB\n" +
	"\xe0A\x02\xfaB\x04r\x02\x10\x01R\bpassword\x125\n" +
	"\x10confirm_password\x18\x06 \x01(\tB\n" +
	"\xe0A\x02\xfaB\x04r\x02\x10\x01R\x0fconfirmPassword\x12\x10\n" +
	"\x03web\x18\n" +
	...
	"\xe0A\x02\xfaB\x04r\x02\x10\x01R\bpassword\x12\x1a\n" +
	...
	"\bredirect\x18\n" +
	" \x01(\tR\bredirect\"J\n" +
	"\x17RefreshTokenAuthRequest\x12/\n" +
	"\rrefresh_token\x18\x04 \x01(\tB\n" +
	"\xe0A\x02\xfaB\x04r\x02\x10\x01R\frefreshToken\"\x9d\x01\n" +
	...
	"\x06expire\x18\x01 \x01(\v2\x19.google.protobuf.DurationR\x06expire\"\xd4\x01\n" +
	...
	"\x05token\x18\n" +
	" \x01(\tB\n" +
	"\xe0A\x02\xfaB\x04r\x02\x10\x01R\x05token\x12\x10\n" +
	...
	"\bredirect\x18\x01 \x01(\tR\bredirect\"\xb7\x01\n" +
	...
	"expires_in\x18\x05 \x01(\x05R\texpiresIn\x12\x1a\n" +
	"\bredirect\x18\n" +
	" \x01(\tR\bredirect\"\xcc\x01\n" +
	"\x1dChangePasswordByForgetRequest\x12>\n" +
	"\x15change_password_token\x18\x01 \x01(\tB\n" +
	"\xe0A\x02\xfaB\x04r\x02\x10\x01R\x13changePasswordToken\x12-\n" +
	"\fnew_password\x18\x05 \x01(\tB\n" +
	"\xe0A\x02\xfaB\x04r\x02\x10\x01R\vnewPassword\x12<\n" +
	"\x14confirm_new_password\x18\x06 \x01(\tB\n" +
	"\xe0A\x02\xfaB\x04r\x02\x10\x01R\x12confirmNewPassword\"\x1d\n" +
	"\x1bChangePasswordByForgetReply\"\xb8\x01\n" +
	"\x1aChangePasswordByPreRequest\x12-\n" +
	"\fpre_password\x18\x04 \x01(\tB\n" +
	"\xe0A\x02\xfaB\x04r\x02\x10\x01R\vprePassword\x12-\n" +
	"\fnew_password\x18\x05 \x01(\tB\n" +
	"\xe0A\x02\xfaB\x04r\x02\x10\x01R\vnewPassword\x12<\n" +
	"\x14confirm_new_password\x18\x06 \x01(\tB\n" +
	"\xe0A\x02\xfaB\x04r\x02\x10\x01R\x12confirmNewPassword\"\x1a\n" +
