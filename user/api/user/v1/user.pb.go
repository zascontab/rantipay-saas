...
const file_user_api_user_v1_user_proto_rawDesc = "" +
	...
	"\x02id\x18\x01 \x01(\tB\n" +
	"\xe0A\x02\xfaB\x04r\x02\x10\x01R\x02id\"\x82\x03\n" +
	"\x04User\x12\x0e\n" +
	...
	"\x04user\x18\x02 \x01(\v2\x1c.user.api.user.v1.UpdateUserB\v\xe0A\x02\xfaB\x05\x8a\x01\x02\x10\x01R\x04user\x12;\n" +
	"\vupdate_mask\x18\x03 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"C\n" +
	"\n" +
	"UpdateUser\x12\x1a\n" +
	"\x02id\x18\x01 \x01(\tB\n" +
	"\xe0A\x02\xfaB\x04r\x02\x10\x01R\x02id\x12\x19\n" +
	...
	"\bidentify\x18\x01 \x01(\tB\n" +
	"\xe0A\x02\xfaB\x04r\x02\x10\x01R\bidentify\"<\n" +
	...
	"\x18GetUserPermissionRequest\x12\x1a\n" +
	"\x02id\x18\x01 \x01(\tB\n" +
	"\xe0A\x02\xfaB\x04r\x02\x10\x01R\x02id\"\x99\x01\n" +
	"\x16GetUserPermissionReply\x124\n" +
	"\x03acl\x18\x01 \x03(\v2\".user.api.permission.v1.PermissionR\x03acl\x12I\n" +
	"\n" +
	"def_groups\x18\x02 \x03(\v2*.user.api.permission.v1.PermissionDefGroupR\tdefGroups\"\x7f\n" +
	"\x1bUpdateUserPermissionRequest\x12\x1a\n" +
	"\x02id\x18\x01 \x01(\tB\n" +
	"\xe0A\x02\xfaB\x04r\x02\x10\x01R\x02id\x12D\n" +
