...
const file_saas_api_tenant_v1_tenant_proto_rawDesc = "" +
	...
	"\x0e_admin_user_id\"\x99\x01\n" +
	"\x13UpdateTenantRequest\x12E\n" +
	"\x06tenant\x18\x01 \x01(\v2 .saas.api.tenant.v1.UpdateTenantB\v\xe0A\x02\xfaB\x05\x8a\x01\x02\x10\x01R\x06tenant\x12;\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"\xb2\x02\n" +
	"\fUpdateTenant\x12\x1a\n" +
	"\x02id\x18\x01 \x01(\tB\n" +
	"\xe0A\x02\xfaB\x04r\x02\x10\x01R\x02id\x12P\n" +
	"\x04name\x18\x02 \x01(\tB<\xe0A\x02\xfaB6r4\x10\x0120^[A-Za-z0-9](?:[A-Za-z0-9\\-]{1,61}[A-Za-z0-9])?$R\x04name\x12!\n" +
	...
	"\x06tenant\x18\x01 \x01(\v2\x1e.saas.api.tenant.v1.TenantInfoR\x06tenant\x12\x17\n" +
	"\ais_host\x18\x02 \x01(\bR\x06isHost\"\xba\x01\n" +
	"\x17UserCreateTenantRequest\x12P\n" +
	"\x04name\x18\x02 \x01(\tB<\xe0A\x02\xfaB6r4\x10\x0120^[A-Za-z0-9](?:[A-Za-z0-9\\-]{1,61}[A-Za-z0-9])?$R\x04name\x12!\n" +
	"\fdisplay_name\x18\x03 \x01(\tR\vdisplayName\x12\x16\n" +
	"\x06region\x18\x04 \x01(\tR\x06region\x12\x12\n" +
